...
export const jobApi = {
  ...
  createJob: async (jobData: JobFormData): Promise<Job> => {
    ...
    const body: any = {
      ...
      currency: jobData.currency, // added currency
    ...
    console.log("[createJob] POST body:", JSON.stringify(body, null, 2));
  ...
  updateJob: async (
    ...
    if (jobData.currency !== undefined) body.currency = jobData.currency; // added currency handling
