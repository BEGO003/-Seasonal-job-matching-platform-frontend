...
export const StatsCard = ({ title, value, icon: Icon, iconBgColor }: StatsCardProps) => {
  return (
    <Card className="p-6 pb-8 overflow-visible hover:shadow-lg transition-all duration-300 hover:scale-105 border-l-4 border-l-primary/30 bg-gradient-to-br from-white to-secondary/30">
