    ...
    return (
      <div className="min-h-screen bg-slate-100">
        ...
        <main className="container mx-auto px-4 py-8 flex flex-col items-center justify-center min-h-[60vh]">
          <h2 className="text-2xl font-bold mb-4 text-slate-900">{t("userNotFound")}</h2>
          <p className="text-slate-600 mb-6">{t("userNotFoundMsg")}</p>
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        >
          <ArrowLeft className="mr-2 h-4 w-4" /> {t("backToApp")}
        </Button>
            ...
            {!resume ? (
              <Card className="border-dashed border-2 shadow-none bg-transparent">
                <CardContent className="flex flex-col items-center justify-center py-12 text-center text-slate-600">
                  ...
                  <h3 className="text-lg font-medium text-slate-900">{t("noResumeInfo")}</h3>
                  <p className="mt-2">{t("noResumeDesc")}</p>
                </CardContent>
              </Card>
            ) : (
              <>
                ...
                <Card className="border-none shadow-sm">
                  <CardHeader className="pb-3 border-b border-slate-200">
                    <div className="flex items-center gap-2">
                      ...
                      <CardTitle className="text-lg font-semibold text-slate-900">{t("education")}</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent className="pt-6">
                    {resume.education && resume.education.length > 0 ? (
                      ...
                      <p className="text-slate-600 italic">{t("noEducation")}</p>
                    )}
                  </CardContent>
                </Card>
                ...
                <Card className="border-none shadow-sm">
                  <CardHeader className="pb-3 border-b border-slate-200">
                    <div className="flex items-center gap-2">
                      ...
                      <CardTitle className="text-lg font-semibold text-slate-900">{t("experience")}</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent className="pt-6">
                    {resume.experience && resume.experience.length > 0 ? (
                      ...
                      <p className="text-slate-600 italic">{t("noExperience")}</p>
                    )}
                  </CardContent>
                </Card>
                ...
                <Card className="border-none shadow-sm">
                  <CardHeader className="pb-3 border-b border-slate-200">
                    <div className="flex items-center gap-2">
                      ...
                      <CardTitle className="text-lg font-semibold text-slate-900">{t("skills")}</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent className="pt-6">
                    {resume.skills && resume.skills.length > 0 ? (
                      ...
                      <p className="text-slate-600 italic">{t("noSkills")}</p>
                    )}
                  </CardContent>
                </Card>
                  ...
                  <Card className="border-none shadow-sm h-full">
                    <CardHeader className="pb-3 border-b border-slate-200">
                      <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-lg font-semibold text-slate-900">{t("certificates")}</CardTitle>
                      </div>
                    </CardHeader>
                    <CardContent className="pt-6">
                      {resume.certificates && resume.certificates.length > 0 ? (
                        ...
                        <p className="text-slate-600 italic">{t("noCertificates")}</p>
                      )}
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-none shadow-sm h-full">
                    <CardHeader className="pb-3 border-b border-slate-200">
                      <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-lg font-semibold text-slate-900">{t("languages")}</CardTitle>
                      </div>
                    </CardHeader>
                    <CardContent className="pt-6">
                      {resume.languages && resume.languages.length > 0 ? (
                        ...
                        <p className="text-slate-600 italic">{t("noLanguages")}</p>
                      )}
                    </CardContent>
                  </Card>
                </div>
